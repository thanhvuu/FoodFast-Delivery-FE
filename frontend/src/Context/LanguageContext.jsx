...
const translationData = {
  vi: {
    ...
    trackingPage: {
      title: 'Theo dõi đơn hàng bằng drone',
      description:
        'Giữ liên lạc với khách hàng và đội vận hành bằng bản đồ trực quan cập nhật vị trí drone theo thời gian thực.',
  ...
  en: {
    ...
    trackingPage: {
      title: 'Track your drone delivery',
      description:
        'Stay in sync with customers and the operations team with a live map that shows the drone approaching in real time.',
      selectorLabel: 'Select an order',
      timelineTitle: 'Flight milestones',
      legend: {
        prefix: 'Drone #',
