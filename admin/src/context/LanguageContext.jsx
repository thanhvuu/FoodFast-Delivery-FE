...
const translations = {
  vi: {
    ...
    addPage: {
      ...
      restaurantNameLabel: 'Tên nhà hàng/quán',
      restaurantNamePlaceholder: 'Ví dụ: FoodFast Quận 5',
      restaurantAddressLabel: 'Địa chỉ nhà hàng',
      restaurantAddressPlaceholder: 'Ví dụ: 273 An Dương Vương, Quận 5, TP.HCM',
      categoryLabel: 'Danh mục',
      categories: [
        { value: 'Fast Food', label: 'Fast Food' },
        { value: 'Đồ ăn vặt', label: 'Đồ ăn vặt' },
        { value: 'Đồ ngọt', label: 'Đồ ngọt' },
        { value: 'Món nước', label: 'Món nước' },
        { value: 'Món khô', label: 'Món khô' },
  ...
  en: {
    ...
    addPage: {
      ...
      restaurantNamePlaceholder: 'e.g. FoodFast District 5',
      restaurantAddressLabel: 'Restaurant address',
      restaurantAddressPlaceholder: 'e.g. 273 An Duong Vuong, District 5, HCMC',
      categoryLabel: 'Product category',
      categories: [
        { value: 'Fast Food', label: 'Fast Food' },
        { value: 'Đồ ăn vặt', label: 'Snacks' },
        { value: 'Đồ ngọt', label: 'Desserts' },
        { value: 'Món nước', label: 'Soups & noodles' },
        { value: 'Món khô', label: 'Dry dishes' },
        { value: 'Thức uống', label: 'Beverages' },
      ],
